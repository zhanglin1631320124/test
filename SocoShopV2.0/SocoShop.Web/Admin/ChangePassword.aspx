<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="True" CodeBehind="ChangePassword.aspx.cs" Inherits="SocoShop.Web.Admin.ChangePassword" %>
...
<div class="add">
	...
	<ul>
		...
		<li class="right"><SkyCES:TextBox CssClass="input" Width="300px" ID="Password" runat="server" CanBeNull="必填" RequiredFieldType="自定义验证表达式" ValidationExpression="^[\W\w]{6,16}$" CustomErr="密码长度大于6位少于16位"  TextMode="Password"/></li>
	</ul>
	<ul>
