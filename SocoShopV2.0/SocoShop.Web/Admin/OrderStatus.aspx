<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="True" CodeBehind="OrderStatus.aspx.cs" Inherits="SocoShop.Web.Admin.OrderStatus" %>
...
<div class="listBlock">
     <ul>
        ...
        <li  class="listOn"><a href="OrderStatus.aspx">状态分析</a></li>
...
<div class="pageMark">	
    ...
    <OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" WIDTH="600" HEIGHT="300" id="OrderGeneral" ALIGN="middle">
        <PARAM NAME="FlashVars" value="&dataXML=<graph caption='订单状态分析' decimalPrecision='2' showPercentageValues='0' showNames='1' showValues='1' showPercentageInLabel='0' pieYScale='45' pieBorderAlpha='40' pieFillAlpha='70' pieSliceDepth='15' pieRadius='100' outCnvBaseFontSize='13' baseFontSize='12'><%=result %></graph>">
        <PARAM NAME="movie" VALUE="flash/pie3d.swf?chartWidth=600&chartHeight=300">
        <PARAM NAME="quality" VALUE="high">
        <PARAM NAME=bgcolor VALUE="#FFFFFF">
        <param name="wmode" value="opaque" />
        <EMBED src="flash/pie3d.swf?chartWidth=600&chartHeight=300" FlashVars="&dataXML=<graph caption='订单状态分析' decimalPrecision='2' showPercentageValues='0' showNames='1' showValues='1' showPercentageInLabel='0' pieYScale='45' pieBorderAlpha='40' pieFillAlpha='70' pieSliceDepth='15' pieRadius='100' outCnvBaseFontSize='13' baseFontSize='12'><%=result %></graph>" quality="high" bgcolor="#FFFFFF" WIDTH="600" HEIGHT="300" wmode="opaque" NAME="OrderGeneral" ALIGN="middle" TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer"></EMBED>
    </OBJECT>
</div>
</asp:Content>
