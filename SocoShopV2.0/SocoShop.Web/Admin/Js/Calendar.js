...
function Calendar(objName) {
    this.style = {
        ...
        borderColor: "#0097CC", //边框颜色
        headerBackColor: "#0097CC", //表头背景颜色
    ...
    this.showYearMonth = false;//只显示年月
    this.Obj = objName;
    this.date = null;
...
Calendar.prototype.toString = function() {
    ...
    str += '<div Author="alin" class="calendar" style="display:none;position:absolute;" onselectstart="return false" oncontextmenu="return false" id="Calendar">\n';
...
Calendar.prototype.getStyle = function() {
    ...
    str += '.calendar{position:absolute;width:140px!important;width:142px;height:194px!important;height:174px;background-color:' + this.style.bodyBackColor + ';border:1px solid ' + this.style.borderColor + ';left:0px;top:0px;z-index:9999;}\n';
    str += '.cdrHeader{background-color:' + this.style.headerBackColor + ';width:142px;height:22px;font-size:11px;color:' + this.style.headerFontColor + ';}\n';
...
Calendar.prototype.onClick = function(obj) {
    if (obj.innerHTML != "") {
        if (this.showYearMonth) {
            this.dateInput.value = obj.value.substring(0, obj.value.lastIndexOf("-"));
        }
        else {
